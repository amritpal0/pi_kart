...
<div class="home-banner-area mb-3">
    <div class="p-0">
        ...
        <div class="home-slider slider-full">
            <div class="flex-grow-1 front-header-search banner_search d-flex align-items-center mx-xl-5">
                <div class="position-relative flex-grow-1 px-3 px-lg-0">
                    <h4>Glow Unveiled Beauty</h4>
            ...
            <div class="aiz-carousel home_banner_img dots-inside-bottom mobile-img-auto-height" data-autoplay="true"
                data-infinite="true">
                @php
